...
exports.OnvifController = exports.NUMBER_OF_LOOP_CHECKING = void 0;
const common_1 = require("@nestjs/common");
const onvif_service_1 = require("./onvif.service");
exports.NUMBER_OF_LOOP_CHECKING = 3;
let OnvifController = class OnvifController {
    constructor(onvifService) {
        this.onvifService = onvifService;
    }
};
OnvifController = __decorate([
    (0, common_1.Controller)('onvif'),
    __metadata("design:paramtypes", [onvif_service_1.OnvifService])
], OnvifController);
